...
fn builtin_models() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        // ══════════════════════════════════════════════════════════════
        ModelCatalogEntry {
            id: "openrouter/openrouter/owl-alpha".into(),
            display_name: "Owl Alpha (OpenRouter)".into(),
        ...
        ModelCatalogEntry {
            id: "openrouter/qwen/qwen3.6-plus".into(),
            display_name: "Qwen3.6 Plus (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Smart,
        ...
        ModelCatalogEntry {
            ...
            display_name: "Gemma 4 31B, free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Fast,
            context_window: 262_144,
        ...
        ModelCatalogEntry {
            ...
            display_name: "Nvidia Nemotron 3 Super 120b-a12b, free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Fast,
            context_window: 262_144,
            max_output_tokens: 262_144,
        ...
        ModelCatalogEntry {
            ...
            display_name: "Minimax M2.5, free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Smart,
        ...
        ModelCatalogEntry {
            id: "openrouter/moonshotai/kimi-k2.6".into(),
            display_name: "MoonshotAI Kimi K2.6 (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Balanced,
        ...
        ModelCatalogEntry {
            id: "openrouter/x-ai/grok-4.3".into(),
            display_name: "xAI Grok 4.3 (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Frontier,
        ...
        ModelCatalogEntry {
            id: "openrouter/xiaomi/mimo-v2.5-pro".into(),
            display_name: "Xiaomi MiMo-V2.5-Pro (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Balanced,
            context_window: 1_048_576,
        ...
        ModelCatalogEntry {
            id: "openrouter/deepseek/deepseek-v4-pro".into(),
            display_name: "DeepSeek V4 Pro (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Frontier,
            context_window: 1_048_576,
        ...
        ModelCatalogEntry {
            id: "openrouter/deepseek/deepseek-v4-flash".into(),
            display_name: "DeepSeek V4 Flash (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Smart,
            context_window: 1_048_576,
            max_output_tokens: 384_000,
